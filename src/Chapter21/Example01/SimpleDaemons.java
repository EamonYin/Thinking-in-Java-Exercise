package Chapter21.Example01;//: concurrency/SimpleDaemons.java
...
public class SimpleDaemons implements Runnable {
  ...
  public static void main(String[] args) throws Exception {
    for(int i = 0; i < 10; i++) {
      ...
      daemon.setDaemon(true); // 线程启动之前调用setSaemon
      daemon.start();
    }
    print("All daemons started");
    TimeUnit.MILLISECONDS.sleep(175);//调整时间，查看mian()【main是非后台进程】提前结束睡眠的样子
  }
} /* Output: (Sample)
All daemons started
