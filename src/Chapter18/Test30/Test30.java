package Chapter18.Test30;// Repair the program CADState.java as described in the text.
import java.io.*;
...
public class Test30 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    ObjectOutputStream out = new ObjectOutputStream(
      new FileOutputStream("./src/Chapter18/Test30/CADState.out"));
    ...
    ObjectInputStream in = new ObjectInputStream(
      new FileInputStream("./src/Chapter18/Test30/CADState.out"));
